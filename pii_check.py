...
pyt.pytesseract.tesseract_cmd = r'C:\Users\Dharamveer\AppData\Local\Programs\Tesseract-OCR\tesseract.exe'
if ext == ".pdf":
...
if contains_pii(extracted_text):
    ...
    def click_handler():
        app.quit()
        Python = r'C:\Users\Dharamveer\Documents\Masking Project\myvenv\Scripts\python.exe'
